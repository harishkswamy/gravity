...
/**
 * This is a mutable container that allows new components and data to be registered with it.
 * 
 * @author Harish Krishnaswamy
 * @version $Id: MutableContainer.java,v 1.6 2004-06-14 04:23:41 harishkswamy Exp $
 */
public interface MutableContainer extends Container
{
     ...
     * @param ctorArgs
     *        The constructor argument values that is to be used while instantiating the component
     *        instance.
     * @param callbacks
     ...
     *        The key that identifies the component within the container.
     * @param srcCompKey
     *        The key that identifies the source component, within the container, the implementation
     *        of which will be reused.
     */
     ...
     * @param facMethodArgs
     *        The factory method argument values that will be needed when requests are delegated.
     * @param callbacks
     *        The callbacks that will be called at the appropriate life cycle phase.
     */
